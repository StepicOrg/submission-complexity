    ...
    def single_input(self):
        ...
        try:
            ...
            if token in [Python3Parser.NEWLINE]:
                ...
                pass
            elif token in [Python3Parser.RETURN, Python3Parser.RAISE, Python3Parser.FROM, Python3Parser.IMPORT,
                           ...
                           Python3Parser.BREAK, Python3Parser.NAME, Python3Parser.STRING_LITERAL,
    ...
    def file_input(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Python3Parser.DEF) | (1 << Python3Parser.RETURN) | (
                ...
                1 << Python3Parser.STAR) | (1 << Python3Parser.OPEN_PAREN) | (1 << Python3Parser.OPEN_BRACK) | (
                1 << Python3Parser.ADD) | (1 << Python3Parser.MINUS))) != 0) or ((((_la - 66)) & ~0x3f) == 0 and (
                (1 << (_la - 66)) & ((1 << (Python3Parser.NOT_OP - 66)) | (1 << (Python3Parser.OPEN_BRACE - 66)) | (
            ...
            if token in [Python3Parser.RETURN, Python3Parser.RAISE, Python3Parser.FROM, Python3Parser.IMPORT,
                ...
                while True:
                    ...
                    if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Python3Parser.DEF) | (
                        ...
                        1 << Python3Parser.CONTINUE) | (1 << Python3Parser.BREAK) | (1 << Python3Parser.NAME) | (
                        1 << Python3Parser.STRING_LITERAL) | (1 << Python3Parser.BYTES_LITERAL) | (
                        1 << Python3Parser.DECIMAL_INTEGER) | (1 << Python3Parser.OCT_INTEGER) | (
                        1 << Python3Parser.HEX_INTEGER) | (1 << Python3Parser.BIN_INTEGER) | (
