...
class Java9Visitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by Java9Parser#type_.
    def visitType_(self, ctx: Java9Parser.Type_Context):
        return self.visitChildren(ctx)
    ...
    def visitUnannClassType_lf_unannClassOrInterfaceType(self,
                                                         ctx: Java9Parser.UnannClassType_lf_unannClassOrInterfaceTypeContext):
        return self.visitChildren(ctx)
    ...
    def visitUnannClassType_lfno_unannClassOrInterfaceType(self,
                                                           ctx: Java9Parser.UnannClassType_lfno_unannClassOrInterfaceTypeContext):
        return self.visitChildren(ctx)
    ...
    def visitUnannInterfaceType_lf_unannClassOrInterfaceType(self,
                                                             ctx: Java9Parser.UnannInterfaceType_lf_unannClassOrInterfaceTypeContext):
        return self.visitChildren(ctx)
    ...
    def visitUnannInterfaceType_lfno_unannClassOrInterfaceType(self,
                                                               ctx: Java9Parser.UnannInterfaceType_lfno_unannClassOrInterfaceTypeContext):
        return self.visitChildren(ctx)
    ...
    def visitPrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primary(self,
                                                                    ctx: Java9Parser.PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext):
        return self.visitChildren(ctx)
    ...
    def visitPrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primary(self,
                                                                        ctx: Java9Parser.PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext):
        return self.visitChildren(ctx)
    ...
    def visitPrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primary(self,
                                                                          ctx: Java9Parser.PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primaryContext):
        return self.visitChildren(ctx)
    ...
    def visitPostIncrementExpression_lf_postfixExpression(self,
                                                          ctx: Java9Parser.PostIncrementExpression_lf_postfixExpressionContext):
        return self.visitChildren(ctx)
